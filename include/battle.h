...
#define IS_TYPE_PHYSICAL(move)(gBattleMoves[move].category == MOVE_CATEGORY_PHYSICAL)
#define IS_TYPE_SPECIAL(move)(gBattleMoves[move].category == MOVE_CATEGORY_SPECIAL)
#define IS_TYPE_STATUS(move)(gBattleMoves[move].category == MOVE_CATEGORY_STATUS)
